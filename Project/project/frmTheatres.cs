...
namespace project
{
    public partial class frmTheatres : Form
    {
        ...
        private void bttnDeleteTheatre_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("This theatre cannot be deleted until all corresponding schedule entries for it has been deleted.");
            }
            catch (Exception err)
            {
        ...
        private void lblMaxTheatreWarning_Click(object sender, EventArgs e)
        {
